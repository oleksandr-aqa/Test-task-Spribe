...
To avoid describing each test case in detail, it was decided to simply write a combination of data for negative and positive checks.
...
### Negative Data Combination (invalid data is **bold**)
...
### Unique Field Data Combination (non-unique data is **bold**)
...
> Required field tests can also be added (for example, password field is not required — bug).
